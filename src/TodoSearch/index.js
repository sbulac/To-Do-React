...
function TodoSearch() {
    ...
    return (
        <div className=' px-4 flex flex-row-reverse justify-center items-center border border-indigo-400 rounded-xl opacity-60 shadow-2xl shadow-indigo-600/50 w-10/12'>
            <input
